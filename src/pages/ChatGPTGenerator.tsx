  ...
  const handleGenerate = () => {
    if (!prompt.trim()) {
      toast({
        ...
        description: "Add some text to generate your ChatGPT prompt.",
        variant: "destructive"
      });
      return;
    }

    const enhancedPrompt = `Enhanced ${promptType} ChatGPT prompt: ${prompt}`;
    setGeneratedPrompt(enhancedPrompt);
    
    toast({
      title: "ChatGPT prompt generated!",
      description: "Your prompt has been enhanced and optimized for ChatGPT."
    });
  };
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center gap-4 mb-8">
            ...
            <span className="px-4 py-2 text-sm bg-blue-100 rounded">ChatGPT Prompt Generator</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
              <CardContent className="p-8">
                {/* Prompt Input Area */}
                <div className="mb-6">
                  <label className="block text-lg font-semibold mb-2">Give me a ChatGPT Prompt to:</label>
                  <Textarea
